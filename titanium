...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Titanium", self)
        about_action.setStatusTip("Find out more about Titanium")  # Hungry!
        about_action.triggered.connect(self.about)
        help_menu.addAction(about_action)

        navigate_mozarella_action = QAction(QIcon(os.path.join('images', 'lifebuoy.png')),
                                            "Titanium Homepage", self)
        navigate_mozarella_action.setStatusTip("Go to Titanium Homepage")
    ...
    def update_title(self, browser):
        ...
        self.setWindowTitle("%s - Titanium" % title)
...
app.setApplicationName("Titanium")
app.setOrganizationName("DSSecret Studios")
app.setOrganizationDomain("dssecret.github.io")
